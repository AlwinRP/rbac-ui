...
import { createPermission } from '../api'; // Ensure this API function is defined in your API service

const PermissionModal = ({ isOpen, onClose, onPermissionCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onPermissionCreated(newPermission);  // Notify parent component with the new permission
      onClose();
    } catch (err) {
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                  ...
                  <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                    <button
                      ...
                      disabled={loading}
                    >
                      {loading ? 'Creating...' : 'Add Permission'}
                    </button>
                    <button
                      type="button"
                      onClick={onClose}
